...
class N2kCanWindow:
    ...
    def __init__(self, parent, server:str):
        ...
        Text(status_box, grid=[0,1], text="Input msg rate")
        self._in_msg_rate = Text(status_box, grid=[1, 1])
        Text(status_box, grid=[2, 1], text='Output msg rate')
        self._out_msg_rate = Text(status_box, grid=[3, 1])
